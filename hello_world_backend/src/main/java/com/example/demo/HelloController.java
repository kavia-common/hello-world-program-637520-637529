...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for helloworldbackend")
public class HelloController {
    
    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to helloworldbackend";
    }
    ...
    public String info() {
        return "Spring Boot Application: helloworldbackend";
    }
} 